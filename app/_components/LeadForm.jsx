...
export default function LeadForm() {
    ...
    return (
        <section className="relative py-16 sm:py-20 px-4 sm:px-6 bg-gradient-to-br from-white via-gray-50 to-gray-100 overflow-hidden">
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <Form {...form}>
                    <motion.form
                        ...
                        className="space-y-6 bg-white backdrop-blur-xl rounded-2xl shadow-lg p-6 md:p-10 border border-gray-200/50 relative overflow-hidden"
                        variants={containerVariants}
                        initial="hidden"
                        animate="visible"
                    >
                        {/* Subtle Overlay */}
                        <div className="absolute inset-0 bg-gradient-to-br from-blue-200/5 to-gray-100/5 pointer-events-none"></div>

                        <motion.div
                            className="absolute top-0 left-0 w-2 h-full bg-gradient-to-b from-blue-400 to-blue-300"
                            initial={{ scaleY: 0 }}
                            animate={{ scaleY: 1 }}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <motion.div variants={fieldVariants} whileHover="hover">
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel className="font-medium text-gray-800 flex items-center gap-2">
                                            ...
                                            <FormControl>
                                                <Input
                                                    ...
                                                    className="h-12 bg-white text-gray-800 border-gray-300 focus:ring-blue-300 focus:border-blue-300 transition-all duration-300 rounded-lg"
                                                    {...field}
                                                />
                                            </FormControl>
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <Select onValueChange={field.onChange} value={field.value}>
                                                <FormControl>
                                                    <SelectTrigger className="h-12 bg-white text-gray-800 border-gray-300 focus:ring-blue-300 focus:border-blue-300 transition-all duration-300 rounded-lg">
                                        ...
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Textarea
                                                    ...
                                                    className="min-h-32 bg-white text-gray-800 border-gray-300 focus:ring-blue-300 focus:border-blue-300 transition-all duration-300 rounded-lg"
                                                    {...field}
                                                />
                                            </FormControl>
                                            <FormMessage className="text-red-500" />
                        ...
                        >
                            <Button
                                type="submit"
                                className="w-full h-14 bg-gradient-to-r from-blue-500 to-blue-400 hover:from-blue-600 hover:to-blue-500 text-white text-lg font-semibold rounded-lg shadow-md hover:shadow-lg transition-all duration-300"
                                disabled={isLoading}
                            >
                                {isLoading ? (
