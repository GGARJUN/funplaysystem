...
function Highlight() {
    ...
    return (
        <motion.div
            className="min-h-screen py-20 px-4 bg-gradient-to-b from-[#b3f5ed] to-[#e6f5fc] relative overflow-hidden"
        >
            {/* Background Decorative Elements */}
            <div className="absolute top-0 left-0 w-64 h-64 bg-[#1abc9c]/20 rounded-full -translate-x-1/2 -translate-y-1/2"></div>
